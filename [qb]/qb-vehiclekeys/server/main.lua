...
RegisterNetEvent('qb-vehiclekeys:server:breakLockpick', function(itemName)
    ...
    if exports['lj-inventory']:RemoveItem(source, itemName, 1, false, 'qb-vehiclekeys:server:breakLockpick') then
        TriggerClientEvent('lj-inventory:client:ItemBox', source, QBCore.Shared.Items[itemName], 'remove')
    end
end)
